(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".popular-products__slider")) new swiper_core_Swiper(".popular-products__slider", {
            ...
            mousewheel: {
                sensitivity: 1,
                eventsTarget: ".popular-products__slider",
                forceToAxis: true
            },
            freeMode: true,
            navigation: {
        ...
        if (document.querySelector(".product-card__slider")) new swiper_core_Swiper(".product-card__slider", {
            ...
            thumbs: {
                swiper: {
                    modules: [ Navigation, Thumb ],
                    el: ".product-card__min-slider",
                    observer: true,
                    observeParents: true,
                    spaceBetween: 10,
                    direction: "vertical",
                    navigation: {
                        prevEl: ".product-card__min-prev",
                        nextEl: ".product-card__min-next"
                    },
                    breakpoints: {
                        320: {
                            slidesPerView: 4
    ...
    document.addEventListener("DOMContentLoaded", (() => {
        document.addEventListener("click", (function(e) {
            ...
            if (targetElement.closest(".card-product__favourites")) {
                targetElement.closest(".card-product__favourites").classList.toggle("card-product__favourites_active");
                e.preventDefault();
            }
        }));
        const rangeSlider = document.getElementById("range-slide");
        if (rangeSlider) noUiSlider.create(rangeSlider, {
            start: [ 100, 1e4 ],
            connect: true,
            step: 1,
            range: {
        ...
        const input0 = document.getElementById("inp-0");
    ...
    document.addEventListener("DOMContentLoaded", (() => {
        const showMore = document.querySelector(".description-product__show-more");
        const itemsLength = document.querySelectorAll(".description-product__item").length;
        let items = 3;
        showMore.addEventListener("click", (() => {
            items += 3;
            const array = Array.from(document.querySelector(".description-product__items").children);
            const visiItems = array.slice(0, items);
            visiItems.forEach((el => el.classList.add("is-visible")));
            if (visiItems.length === itemsLength) showMore.style.display = "none";
        }));
    }));
    document.addEventListener("DOMContentLoaded", (() => {
        const search = document.querySelector(".search");
        const searchMagnifier = document.querySelector(".search__magnifier");
        ...
        if (search) searchMagnifier.addEventListener("click", (function(e) {
            search.classList.add("_search-active");
            headerLinks.classList.add("header__links_mod");
            headerDesc.classList.add("header__desc_mod");
            headerCatalog.classList.add("header__catalog_mod");
            menuBox.classList.add("menu__box_mod");
        }));
        if (searchClose) searchClose.addEventListener("click", (function(e) {
            search.classList.remove("_search-active");
            headerLinks.classList.remove("header__links_mod");
            headerDesc.classList.remove("header__desc_mod");
            searchWindow.classList.remove("_active-search-window");
            headerCatalog.classList.remove("header__catalog_mod");
            menuBox.classList.remove("menu__box_mod");
        }));
        if (searchInput) searchInput.addEventListener("click", (function(e) {
            searchWindow.classList.add("_active-search-window");
        }));
    ...
    document.addEventListener("DOMContentLoaded", (() => {
        const filterItems = document.querySelectorAll(".filter-catalog__item");
        filterItems.forEach((filterItem => {
            filterItem.addEventListener("click", (e => {
                filterItems.forEach((el => {
                    el.classList.remove("filter-catalog__item_active");
                }));
                filterItem.classList.add("filter-catalog__item_active");
            }));
        }));
    }));
    window["FLS"] = true;
